...
GradPenalLogLik <- function(param, X, YNT, riskNT, riskT, YT, TimeBase, TimePen, lambda) {
    .Call('_LongitSemiComp_GradPenalLogLik', PACKAGE = 'LongitSemiComp', param, X, YNT, riskNT, riskT, YT, TimeBase, TimePen, lambda)
}

GradPenalLogLikPers <- function(param, X, YNT, riskNT, riskT, YT, TimeBase, TimePen, lambda) {
    .Call('_LongitSemiComp_GradPenalLogLikPers', PACKAGE = 'LongitSemiComp', param, X, YNT, riskNT, riskT, YT, TimeBase, TimePen, lambda)
}
