...
//' @export
// [[Rcpp::export]]
arma::mat GradPenalLogLikPersWithInter(arma::vec param, arma::mat YNT, arma::mat riskNT, arma::mat riskT, arma::mat YT, 
...
// Decomposing "param" to individual paramters as in LogLik
  ...
  arma::mat GradSquare(1 + 3*Q + pNT + pT + pOR + pGammaInter, 1 + 3*Q + pNT + pT + pOR + pGammaInter);
  Grad.fill(0);
  iGrad.fill(0);
  GradSquare.fill(0);
